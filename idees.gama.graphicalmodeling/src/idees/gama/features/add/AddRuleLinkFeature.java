...
public class AddRuleLinkFeature extends AbstractAddFeature {
 
    public AddRuleLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
    	ERuleLink addedEReference = (ERuleLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof ERuleLink) {
    		 return true;
        }
    	return false;
    }
