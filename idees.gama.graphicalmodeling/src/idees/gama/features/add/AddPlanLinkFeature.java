...
public class AddPlanLinkFeature extends AbstractAddFeature {
 
    public AddPlanLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
    	EPlanLink addedEReference = (EPlanLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EPlanLink) {
    		 return true;
        }
    	return false;
    }
