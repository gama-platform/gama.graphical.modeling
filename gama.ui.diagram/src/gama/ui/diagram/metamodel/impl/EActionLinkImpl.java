...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EAction Link</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gama.ui.diagram.metamodel.impl.EActionLinkImpl#getAction <em>Action</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.EActionLinkImpl#getSpecies <em>Species</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EActionLinkImpl extends EGamaLinkImpl implements EActionLink {
	...
	public EAction getAction() {
		if (action != null && action.eIsProxy()) {
			...
			action = (EAction)eResolveProxy(oldAction);
			if (action != oldAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamaPackage.EACTION_LINK__ACTION, oldAction, action));
			}
		}
		return action;
	}
	...
	public void setAction(EAction newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamaPackage.EACTION_LINK__ACTION, oldAction, action));
	}
	...
	public ESpecies getSpecies() {
		if (species != null && species.eIsProxy()) {
			...
			if (species != oldSpecies) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GamaPackage.EACTION_LINK__SPECIES, oldSpecies, species));
			}
		}
		return species;
	}
	...
	public void setSpecies(ESpecies newSpecies) {
		...
		species = newSpecies;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamaPackage.EACTION_LINK__SPECIES, oldSpecies, species));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GamaPackage.EACTION_LINK__ACTION:
				if (resolve) return getAction();
				return basicGetAction();
			case GamaPackage.EACTION_LINK__SPECIES:
