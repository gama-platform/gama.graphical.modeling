 ...
 * </p>
 * <ul>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ETaskImpl#getGamlCode <em>Gaml Code</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ETaskImpl#getTaskLinks <em>Task Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ETaskImpl extends EGamaObjectImpl implements ETask {
	/**
	...
	protected EClass eStaticClass() {
		return GamaPackage.Literals.ETASK;
	}
	...
	public void setGamlCode(String newGamlCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamaPackage.ETASK__GAML_CODE, oldGamlCode, gamlCode));
	}
	...
	public EList<ETaskLink> getTaskLinks() {
		if (taskLinks == null) {
			taskLinks = new EObjectResolvingEList<ETaskLink>(ETaskLink.class, this, GamaPackage.ETASK__TASK_LINKS);
		}
		return taskLinks;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GamaPackage.ETASK__GAML_CODE:
				return getGamlCode();
			case GamaPackage.ETASK__TASK_LINKS:
				return getTaskLinks();
		}
