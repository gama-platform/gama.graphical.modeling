 ...
 * </p>
 * <ul>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getReflexList <em>Reflex List</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getExperimentLinks <em>Experiment Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getAspectLinks <em>Aspect Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getActionLinks <em>Action Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getReflexLinks <em>Reflex Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getMicroSpeciesLinks <em>Micro Species Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getMacroSpeciesLinks <em>Macro Species Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getSkills <em>Skills</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getInheritsFrom <em>Inherits From</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getInit <em>Init</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getInheritingLinks <em>Inheriting Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getPlanLinks <em>Plan Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getStateLinks <em>State Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getTaskLinks <em>Task Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getPerceiveLinks <em>Perceive Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getRuleLinks <em>Rule Links</em>}</li>
 *   <li>{@link gama.ui.diagram.metamodel.impl.ESpeciesImpl#getEquationLinks <em>Equation Links</em>}</li>
 * </ul>
 *
 * @generated
 */
