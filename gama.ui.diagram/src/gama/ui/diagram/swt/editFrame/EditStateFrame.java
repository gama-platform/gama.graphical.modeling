...
public class EditStateFrame extends EditActionFrame {

	/**
	 * Create the application window.
	 */
	public EditStateFrame(final Diagram diagram, final IFeatureProvider fp, final EditFeature erf,
		final EGamaObject reflex) {
		super(diagram, fp, erf, reflex, "State definition");
	}
			...
			domain.getCommandStack().execute(new RecordingCommand(domain) {
				...
				public void doExecute() {
					if ( name == null) {
						...
						saveFacets();
						if ( modelXText != null ) {
							((EState) eobject).setGamlCode(modelXText.getEditablePart());
						}
