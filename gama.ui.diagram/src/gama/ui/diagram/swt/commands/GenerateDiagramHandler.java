...
/*******************************************************************************************************
 *
 * GenerateDiagramHandler.java, in gama.ui.diagram.graphicalmodeling, is part of the source code of the GAMA modeling and
		...
		Display.getCurrent().asyncExec(() -> {
			...
			try {
				final IEditorPart ep =
						pag.openEditor(editorInput, "gama.ui.diagram.graphicalmodeling.diagram.gamadiagrameditor");
