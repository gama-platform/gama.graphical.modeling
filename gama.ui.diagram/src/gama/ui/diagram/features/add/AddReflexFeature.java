...
public class AddReflexFeature extends AbstractAddShapeFeature {
	...
	private static final List<Integer> CLASS_BACKGROUND = Arrays.asList(221, 160, 221);

	public AddReflexFeature(final IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(final IAddContext context) {
		EReflex addedClass = (EReflex) context.getNewObject();
