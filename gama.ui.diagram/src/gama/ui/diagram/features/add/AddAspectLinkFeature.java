...
public class AddAspectLinkFeature extends AbstractAddFeature {
 
    public AddAspectLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
    	EAspectLink addedEReference = (EAspectLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EAspectLink) {
    		 return true;
        }
    	return false;
    }
