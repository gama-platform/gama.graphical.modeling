...
public class AddStateLinkFeature extends AbstractAddFeature {
 
    public AddStateLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
        EStateLink addedEReference = (EStateLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EStateLink) {
    		 return true;
        }
    	return false;
    }
