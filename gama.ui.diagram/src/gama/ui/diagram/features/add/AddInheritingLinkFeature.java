...
public class AddInheritingLinkFeature extends AbstractAddFeature {
 
    public AddInheritingLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
        EInheritLink addedEReference = (EInheritLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EInheritLink) {
    		 return true;
        }
    	return false;
    }
