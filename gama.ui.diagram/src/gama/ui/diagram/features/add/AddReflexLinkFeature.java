...
public class AddReflexLinkFeature extends AbstractAddFeature {
 
    public AddReflexLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
        EReflexLink addedEReference = (EReflexLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof EReflexLink) {
    		 return true;
        }
    	return false;
    }
