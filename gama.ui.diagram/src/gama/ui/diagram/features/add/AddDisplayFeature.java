/*******************************************************************************************************
 *
 * AddDisplayFeature.java, in gama.ui.diagram.graphicalmodeling, is part of the source code of the GAMA modeling and
...
public class AddDisplayFeature extends AbstractAddShapeFeature {
	...
	private static final List<Integer> CLASS_BACKGROUND = Arrays.asList(127, 255, 0);

	/**
	 * Instantiates a new adds the display feature.
	 *
	 * @param fp
	 *            the fp
	 */
	public AddDisplayFeature(final IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(final IAddContext context) {
		...
		if ((context.getNewObject() instanceof EDisplay) && (context.getTargetContainer() instanceof Diagram))
			return true;
		return false;
	}
