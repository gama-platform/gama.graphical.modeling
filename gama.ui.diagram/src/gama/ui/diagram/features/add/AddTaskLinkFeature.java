...
public class AddTaskLinkFeature extends AbstractAddFeature {
    ...
    public AddTaskLinkFeature (IFeatureProvider fp) {
        super(fp);
    }
 
    public PictogramElement add(IAddContext context) {
    	IAddConnectionContext addConContext = (IAddConnectionContext) context;
        ETaskLink addedEReference = (ETaskLink) context.getNewObject();
    ...
    public boolean canAdd(IAddContext context) {
       ...
       if (context instanceof IAddConnectionContext
            && context.getNewObject() instanceof ETaskLink) {
    		 return true;
        }
    	return false;
    }
